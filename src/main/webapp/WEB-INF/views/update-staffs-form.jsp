			...
			<div>
				<form:form action="updatestaff" method="post"
					...
					<div class="const">
						...
						<form:radiobutton path="role" value="Perform diagnostic tests" />
						Assess the patient :
						<form:radiobutton path="role" value="Assess the patient" />
						Management of illness :
						<form:radiobutton path="role" value="Management of illness" />
					</div>
					<div>
					...
					<div>
						...
						<form:radiobutton path="speciality" value="Pediatrics" />
						Geriatrics :
						<form:radiobutton path="speciality" value="Geriatrics" />
						Pain care :
						<form:radiobutton path="speciality" value="Pain care" />
						Wound care :
						<form:radiobutton path="speciality" value=" Wound care" />
						Mental health :
						<form:radiobutton path="speciality" value="Mental health" />
						Specific disease:
