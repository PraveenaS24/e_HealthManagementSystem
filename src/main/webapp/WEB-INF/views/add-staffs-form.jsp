...
<style>
body {
	background-image: linear-gradient( black,lightslategray, gray);
				...
				<form:form action="addstaff" method="post"
					...
					<tr>
						<div class="const">
							...
							<td>Perform diagnostic tests : <form:radiobutton path="role"
									value="Perform diagnostic tests" /> Assess the patient : <form:radiobutton
									path="role" value="Assess the patient" /> Management of
								illness : <form:radiobutton path="role"
									value="Management of illness" />
							</td>
						</div>
					</tr>
					<tr>
					...
					<tr>
						<div>
							...
							<td>Pediatrics : <form:radiobutton path="speciality"
									...
									path="speciality" value="Mental health" /> Specific disease: <form:radiobutton
									path="speciality" value="Specific disease" />
							</td>
						</div>
					</tr>
					<tr>
